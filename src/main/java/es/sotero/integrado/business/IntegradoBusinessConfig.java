package es.sotero.integrado.business;
...
@EnableJpaRepositories("es.sotero.integrado.business.repositories")
@EnableTransactionManagement
public class IntegradoBusinessConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        emf.setPackagesToScan(Piloto.class.getPackage().getName());
