...
<body>
	<h1>Resultado de la búsqueda con ID <c:out value="${model.idModelo}"></c:out></h1>
	...
	<table>
		...
		<tr>
			<th><c:out value="${model.idModelo}"></c:out></th>
	...
	<a href="<c:url value="getModelo.htm"/>">Buscar otro modelo</a>
</body>
</html></html>